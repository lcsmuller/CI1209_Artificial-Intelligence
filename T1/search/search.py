    ...
    while not queue.isEmpty():
        ...
        if state not in visited_states:
            ...
            for new_state, new_action, new_cost in problem.getSuccessors(state):
                ...
                queue.push((new_state, curr_cost, path + [new_action]), curr_cost)
...
def aStarSearch(problem: SearchProblem, heuristic=nullHeuristic):
    ...
    while not queue.isEmpty():
        ...
        if state not in visited_states:
            ...
            for new_state, new_action, new_cost in problem.getSuccessors(state):
                g_fn_cost = new_cost + cost
                h_fn_cost = heuristic(new_state, problem)
                f_fn_cost = g_fn_cost + h_fn_cost
                queue.push((new_state, g_fn_cost, path + [new_action]), f_fn_cost)
